              ...
              <>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                        ...
                        {authorizedSignatureUrl && (
                          <button type="button" onClick={() => setAuthorizedSignatureUrl(null)} className="text-xs text-red-600 hover:underline">
                            Remove
                          </button>
                        )}
                      </div>
                  ...
                  <input
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyName: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                  />
                  <textarea
                    placeholder={getPlaceholderForKey('companyAddress', 'Company Address')}
                    value={invoiceData.companyAddress || ''}
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyAddress: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                    rows={2}
                  ></textarea>
                  <input
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyEmail: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                  />
                  <input
                    type="tel"
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyPhone: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                  />
                    ...
                    <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyBankName: e.target.value }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyAccountNo: e.target.value }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyCustomerId: e.target.value }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyBankBranch: e.target.value }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), companyIfscCode: e.target.value }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                    </div>
                  ...
                  {activeTemplateName === 'Invoice' && (
                    <textarea
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), declaration: e.target.value }))}
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <input
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), clientName: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                  />
                  {activeTemplateName !== 'Invoice' && (
                    <input
                  ...
                  <textarea
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), clientAddress: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                    rows={2}
                  ></textarea>
                  {activeTemplateName === 'Invoice' && (
                ...
                {activeTemplateName === 'Invoice' && (
                  <div className="space-y-4 mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeName: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <textarea
                      placeholder={getPlaceholderForKey('consigneeAddress', 'Consignee Address')}
                      value={invoiceData.consigneeAddress || ''}
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeAddress: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                      rows={2}
                    ></textarea>
                    <input
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeGstin: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeState: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeContactPerson: e.target.value }))}
                        className="w-1/2 p-2 border rounded-md"
                      />
                      <input
                        type="text"
                        ...
                        onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), consigneeContact: e.target.value }))}
                        className="w-1/2 p-2 border rounded-md"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <input
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), projectSubject: e.target.value }))}
                    className="w-full p-2 border rounded-md"
                  />
                  <div className="flex space-x-2">
                    <input
                    ...
                    <input
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), quotationNumber: e.target.value }))}
                      className="w-1/2 p-2 border rounded-md"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), requisitioner: e.target.value }))}
                        className="w-full p-2 border rounded-md"
                      />
                    </div>
                    <div className="flex space-x-2">
                      <input
                        ...
                        onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), shipVia: e.target.value }))}
                        className="w-1/2 p-2 border rounded-md"
                      />
                      <input
                        type="text"
                        ...
                        onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), fob: e.target.value }))}
                        className="w-1/2 p-2 border rounded-md"
                      />
                    </div>
                    <div>
                ...
                {activeTemplateName === 'Invoice' && (
                  <div className="space-y-4 mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), deliveryNote: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), buyersOrderNo: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), dispatchDocNo: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), dispatchedThrough: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), destination: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                    <input
                      type="text"
                      ...
                      onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), termsOfDelivery: e.target.value }))}
                      className="w-full p-2 border rounded-md"
                    />
                  </div>
                )}
                ...
                <div className="space-y-4 mb-6">
                  <textarea
                    ...
                    onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), notes: e.target.value }))}
                    className="w-full p-3 border rounded-md"
                    rows={3}
                  ></textarea>
                    ...
                    <div className="space-y-4 mb-2">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setInvoiceData((prev: any) => ({ ...(prev || {}), roundOff: parseFloat(e.target.value) || 0 }))}
                          className="w-full p-2 border rounded-md"
                        />
                      </div>
                    </div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setInvoiceData((prev: any) => ({ ...(prev || {}), template: e.target.value }));
                    }}
                    className="w-full p-3 border rounded-md bg-white"
                  >
